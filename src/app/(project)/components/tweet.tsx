...
import { Tweet as TweetComponent, getTweet } from "react-tweet/api";
...
async function getAndCacheTweet(
  id: string
): Promise<TweetComponent | undefined> {
  ...
  const cachedTweet: TweetComponent | null = await redis.get(`tweet:${id}`);
